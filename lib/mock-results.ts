  ...
  rs_demo_001: {
    ...
    tables: {
      core_metrics: {
        ...
        rows: [
          [
            "Cash-in за прошлый месяц",
            "1900 USD",
            "фактически полученный платеж",
          ],
          [
    ...
    missing_data: [
      ...
      },
      {
        ...
        reason:
          "неясно, относятся ли лиды, клиенты и cash-in к одному и тому же месяцу",
      },
      {
      ...
      },
      {
        ...
        reason:
          "есть механики удержания, но нет фактической метрики удержания",
      },
      {
        field: "sales_cycle_average_days",
        reason:
          "есть этапы CJM, но нет единого замера реального цикла сделки по клиентам",
      },
    ],
    ...
    roadmap: {
      ...
      control_points: [
        ...
        {
          metric:
            "Конверсия из квалифицированного лида в сделку по входному офферу",
          signal:
            "Если конверсия не улучшается после сужения оффера, проблема остается в ценностном сообщении или в выборе оффера.",
          why_it_matters: "Это ключевой сигнал, работает ли leverage-фаза.",
          confidence_level: "medium",
        },
        {
    ...
    forecasts: {
      current_vs_target: {
        current_state: {
          ...
          conversion: "7.69%",
          capacity: "4",
          demand_to_capacity: "3.25x",
        },
        target_state: {
          revenue: "стабильный поток",
          conversion: "выше текущей",
          capacity: "управляемая и расширяемая",
          processing: "без ручного bottleneck у founders",
        },
        gap_summary:
          "Главный разрыв — processing capacity и founder-led delivery, а не отсутствие спроса.",
        confidence_level: "preliminary",
      },
    },
    ...
    overall_conclusions: {
      ...
      solution: {
        ...
        primary_constraint: {
          label: "Founder-centric управленческая и операционная перегрузка",
          reason:
            "Ключевой лимит роста находится в структуре: два основателя держат решения, обработку спроса и delivery.",
          supported_by_blocks: [
            "structure_processes",
            "clients_flow",
            "strategy",
      ...
      positioning: {
        truth_summary: {
          summary:
            "На практике это founder-led сервисный hybrid: компания продает стратегию плюс hands-on реализацию, а не узкий продукт.",
          confidence_level: "preliminary",
        },
      },
      economics: {
        truth_summary: {
          summary:
            "Текущая экономика не является устойчивой нормой: 55% маржи и 1045 USD прибыли основаны на одном клиенте.",
          confidence_level: "preliminary",
        },
      },
      clients_flow: {
        truth_summary: {
          summary:
            "Поток ломается из-за сочетания низкой конверсии и сильной перегрузки обработки.",
          confidence_level: "preliminary",
        },
      },
      product_sales: {
        truth_summary: {
          summary:
            "Сейчас выручка держится на единичной сделке, а не на повторяемом потоке клиентов или работающем retention.",
          confidence_level: "preliminary",
        },
      },
      analytics_management: {
        truth_summary: {
          summary:
            "Бизнес уже видит базовые цифры, но решения остаются у двух основателей и модель управления пока полу-ручная.",
          confidence_level: "medium",
        },
      },
      structure_processes: {
        truth_summary: {
          summary:
            "Бизнес реально держится на двух основателях, которые одновременно принимают решения и закрывают почти все функции.",
          confidence_level: "medium",
        },
      },
      strategy: {
        truth_summary: {
          summary:
            "Стратегически бизнес хочет расти, но сейчас ограничение не в амбиции, а в пропускной способности и исполнении.",
          confidence_level: "preliminary",
        },
      },
    },
