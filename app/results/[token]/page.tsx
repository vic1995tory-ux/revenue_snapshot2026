...
function HeroSection({
  ...
  const companyName = hero.companyName?.trim() || company.name || "Revenue Snapshot";
  ...
  const geoLabel =
    safeStringArray(hero.sales_geography?.length ? hero.sales_geography : company.sales_geography).join(" / ") || "—";
        ...
        <div className="border-b border-white/10 p-6 md:p-8 xl:border-b-0 xl:border-r xl:p-10">
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-2">
            ...
            <HeroInfoTile
              ...
              value={demandRatio}
              subvalue={`${formatNumber(demand)} leads / ${formatNumber(capacity)} capacity`}
            />
            <HeroInfoTile
              label="growth limit"
              value={growthLimit}
