...
function TariffCard({
  ...
  return (
    <div className="tariff-card tilt-card">
      <div className="tariff-tilt tilt-inner">
        ...
        <a href={href} className="tariff-play" aria-label={`Открыть ${title}`}>
...
function ResultMiniCard({
  ...
  return (
    <article className="result-mini-card">
      <div className="result-mini-tag">{tag}</div>
      <h3>{title}</h3>
      <p>{text}</p>
    </article>
  );
            ...
            <div className="signal-board">
              <article className="signal-card signal-lg">
                ...
                <ul>
                  ...
                  <li>какой сегмент готов реагировать первым</li>
                </ul>
              </article>
              ...
              <article className="signal-card signal-lg">
                ...
                <ul>
                  ...
                  <li>где ручное управление тормозит рост</li>
                </ul>
              </article>
              ...
              <article className="signal-card">
                ...
                <ul>
                  ...
                  <li>какой рычаг даёт главный финансовый сдвиг</li>
                </ul>
              </article>
              ...
              <article className="signal-card">
                ...
                <ul>
                  ...
                  <li>где теряется конверсия по пути</li>
                </ul>
              </article>
              ...
              <article className="signal-card">
                ...
                <ul>
                  ...
                  <li>какая версия оффера масштабируется</li>
                </ul>
              </article>
            </div>
      ...
      <style jsx global>{`
        ...
        * { box-sizing: border-box; }
        ...
        .tariff-play {
          ...
          box-shadow: 0 16px 34px rgba(8,14,28,.22), inset 0 1px 0 rgba(255,255,255,.18);
          transition: transform .24s ease-out, box-shadow .24s ease-out, filter .24s ease-out;
        }
        ...
        .tariff-play-triangle {
          ...
          border-left: 28px solid #08285b;
          margin-left: 5px;
          filter: drop-shadow(0 8px 18px rgba(4,16,39,.18));
        }

        .tilt-card:hover .tariff-play {
          transform: translateY(-2px) translateZ(24px);
          box-shadow: 0 20px 40px rgba(8,14,28,.28), inset 0 1px 0 rgba(255,255,255,.22);
