...
export function AnalyticsManagementBlock({
  block,
}: {
    ...
    <article className="rounded-[28px] border border-white/10 bg-[#0d1c36] p-6">
      ...
      <div className="mt-6 grid gap-4 lg:grid-cols-2">
        <div className="rounded-[20px] border border-white/10 bg-white/5 p-5">
          <div className="text-sm text-white/50">Why the system concluded this</div>
        ...
        <div className="rounded-[20px] border border-white/10 bg-white/5 p-5">
          <div className="text-sm text-white/50">Business implication</div>
          <p className="mt-3 text-[15px] leading-[1.65] text-white/72">
            {block.implication}
          </p>
        </div>
